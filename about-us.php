        ...
        <div class="template-layout-50x50 template-clear-fix">
          ...
          <div class="template-layout-column-left">
            ...
            <div class="template-component-header-subheader template-align-left">
              <h2>ECCA Car Wash</h2>
              <div></div>
              <span>AIMS Eco Car Care LLP</span>
            </div>

            <!-- Text -->
            <p class="template-padding-reset">
              We operate three car washes throughout Pune area.
              Our goal is to provide our customers with the friendliest, most convenient hand car wash experience possible.
              We use the most modern and up-to-date water conservation modules as a part of our waterless car wash systems. Our products are eco-friendly.
            </p>
            ...
            <!-- Button -->
            <a href="booking.php" class="template-component-button">Our Packages</a>

          </div>

          <div class="template-layout-column-right template-margin-bottom-reset">

            <img src="media/image/home_about.jpg">
      ...
      <div class="template-section template-section-padding-reset template-clear-fix">
        ...
        <div class="template-layout-flex template-clear-fix template-background-color-1">
          ...
          <div class="template-background-image ">
            ...
            <iframe style="width: 100%;height: 100%" src="https://www.youtube.com/embed/rFITgIeov9k" frameborder="0" allow="accelerometer; autoplay;" allowfullscreen></iframe>
          ...
          <div>
            ...
            <div class="template-component-tab">
              ...
              <!-- Navigation -->
              <ul>
                <li><a href="#tab-1-about-us">Our Vision</a></li>
              ...
              <div id="tab-1-about-us">
                <p class="template-component-italic template-padding-reset">
                  To make your car as well as Earth shine, by saving water!
                </p>
              ...
              <div id="tab-1-our-mission">
                <p class="template-component-italic template-padding-reset">
                  Our mission is to see the entire earth shine just as bright as your car.
                </p>
                <p class="template-padding-reset template-margin-top-2">
                  With an aim to make a real difference in our fast paced world, ECCA – AquaSmart Car Care provided by AIMS ECO CAR LLP is conceived by passionate individuals who believe that if each one does a little, the entire world can change!	<br>
Disturbed by the increasing threat of global warming, and other factors contributed by the urban landscape, ECCA envisions being the movement which makes a substantial impact on saving water, one car at a time.
          ...
          <ul class="template-layout-33x33x33 template-clear-fix">
            ...
            <li class="template-layout-column-left">
              ...
              <div class="template-component-image template-component-image-preloader">
                <img src="media/image/mehtab.jpg" alt="" class="template-component-team-list-image"/>
              </div>
              ...
              <p class="template-component-team-list-description">
                With over 10 years experience of Corporate Sales in Cloud based Services and Corporate Mind Trainings across various sectors, Mehtab dreamt of being an entrepreneur with a difference. Having traveled extensively across the world, he wanted to venture into a business that would add value to society as a whole: Giving birth to his brainchild ECCA - Aqua Smart Car Care.
              </p>
              ...
              <ul class="template-component-social-icon-list ">
                <li><a href="#"><img src="media/image/facebook.png"></a></li>
                <li><a href="#"><img src="media/image/twitter.png"></a></li>
                <li><a href="#"><img src="media/image/linkedin.png"></a></li>
              </ul>
            ...
            <li class="template-layout-column-right">
              <div class="template-component-image template-component-image-preloader">
                <img src="media/image/ankush.jpg" alt="" class="template-component-team-list-image"/>
              </div>
              <h6 class="template-component-team-list-name">
                Mr. Ankush Yadav
              </h6>
      ...
      <div class="template-section template-section-padding-reset template-clear-fix template-background-color-1">
        ...
        <div class="template-component-call-to-action" style="background-image: url(media/image/background-image/bg2.jpg);">
          <div class="template-main">
            ...
            <a href="booking.php" class="template-component-button">Buy Now</a>
          </div>
        </div>
