			...
			<body class="template-page-home">
				...
				<div class="template-header" >
					...
					<div class="template-header-bottom">
						   ...
						   <div class="slide">
						       <img src="media/image/4.jpg" />
						   </div>
						   <div class="slide">
						       <img src="media/image/5.jpg" />
						   </div>
						</div>					
				...
				<div class="template-content">
					...
					<div class="template-section template-section-padding-1 template-clear-fix template-main">
						...
						<div class="template-component-header-subheader">
							<h2>What is ECCA?</h2>
							<div></div>
							<span>Waterless car wash service - Economical, Ecological &amp; Ecofriendly.</span>
						</div>	
						...
						<div class="template-layout-33x66 template-clear-fix">
							...
							<div class="template-layout-column-left">
								<img src="media/image/sample/460x678/home_about.jpg" alt=""/>
							</div>
							...
							<div class="template-layout-column-right">
								...
								<p class="template-padding-reset">
									Based out of Pune, ECCA was founded in 2019 with aim to make a difference to the society at providing services that comprise of, "The best in car care innovation" and "Water conservation in our urban lifestyles today." ECCA is the brain child of our founder Mr. Mehtab Alam, who was disturbed by the fact that across the country lakhs of litres of water is wasted in just cleaning of cars every day. Thus ECCA’s goal is to provide our customers with most eco-friendly car care solutions with convenience of service at door step at an affordable rate so that more and more responsible citizens join hands with us in our mission to conserve water.
								</p>
								...
								<div class="template-component-feature-list template-component-feature-list-position-top template-clear-fix">
									...
									<ul class="template-layout-50x50 template-clear-fix">
										...
										<li class="template-layout-column-left template-margin-bottom-reset">
											...
											<h5>The Best Car Wash Service</h5>
											<ul class="template-component-list">
												<li><span class="template-icon-meta-check"></span>Multiple service packages to suit your needs</li>
												<li><span class="template-icon-meta-check"></span>Biodegradable and eco-friendly products</li>
												<li><span class="template-icon-meta-check"></span>Professionally trained and skilled car wash crew</li>
												<li><span class="template-icon-meta-check"></span>Convenient service time slots</li>
											</ul>
										</li>
										...
										<li class="template-layout-column-right template-margin-bottom-reset">
											...
											<h5>Get a Free Demo</h5>
											<ul class="template-component-list">
												<li><span class="template-icon-meta-check"></span>Experience difference between your regular and ECCA Waterless Car Wash</li>
												<li><span class="template-icon-meta-check"></span><a href="tel:7058420909">Call</a> or <a href="mailto:sales@theecca.com">Email Us</a></li>
												<li><span class="template-icon-meta-check"></span>Book your appointment for Free Demo</li>
											</ul>											
										</li>
						...
						<!-- Section -->
					<div class="template-section template-section-padding-reset template-clear-fix" style="margin-top: -12%;">
						
						<!-- Flex layout 50x50% -->
						<div class="template-layout-flex template-background-color-1 template-clear-fix">

							<!-- Left column -->
							<div class="template-background-image"><iframe style="width: 100%;height: 100%" src="https://www.youtube.com/embed/rFITgIeov9k" frameborder="0" allow="accelerometer; autoplay;" allowfullscreen></iframe></div>

							<!-- Right column -->
							<div class="template-section-padding-1 feature">
								...
								<div class="template-component-feature-list template-component-feature-list-position-top">
									...
									<ul class="template-layout-50x50 template-clear-fix">
										...
										<li class="template-layout-column-left">
											...
											<h5>Convenience</h5>
											<p>We are dedicated to provide the best quality car care at your doorstep, during your chosen time slot. You can also conveniently track the services provided to you through our Mobile Application. Our services will soon be available across major cities in India.</p>
										</li>
										...
										<li class="template-layout-column-right">
											...
											<p>Our services not only ensure that you drive a spotlessly clean car every time but they also help you save time and money. Since we regularly provide both exterior and interior cleaning you do not need to take your car to any car wash centre. With ECCA you contribute to saving 9000 Litres of water making it a great value for money!</p>											
										</li>
										...
										<li class="template-layout-column-left">
											...
											<p>Our crew is professionally trained and is highly skilled in executing ECCA Car Wash service in less time and with high accuracy to make your car shine as brand new. They are in specially provided ECCA uniform and carry ID cards to ensure the security of your vehicles. Additionally, our strong back-end team ensures your queries are addressed immediately.</p>											
										</li>
										...
										<li class="template-layout-column-right">
											...
											<h5>Eco-friendly &amp; Car-friendly</h5>
											<p>Our car wash process is the most eco-friendly as it uses only 2 glasses of water per car per wash as against 25-30 litres used by your usual car washer. We use biodegradable washing product and world’s finest microfiber to clean car which not only protects your car from wear and tear, but is also safe for environment.</p>											
										</li>
							...
							<div>
								...
								<div class="template-component-testimonial-list template-clear-fix">
									...
									<ul class="template-clear-fix">
										<li>
											<p>The best and the quality service by ECCA. Completely satisfied.</p>
											<h6>D.K. Rama Swamy</h6>
											<span>Associate V.P., Bharat Forge</span>
										</li>
										<li>
											<p>The best and the quality service by ECCA. Completely satisfied.</p>
											<h6>Anurag Srivastava</h6>
											<span>Assistant Consultant, TCS</span>
										</li>
										<li>
											<p>Excellent service. I am amazed to see such a nice way to service a car.</p>
											<h6>Akash Pandey</h6>
											<span>Associate Finance Manager, Nihilent Limited</span>
										</li>
                                        <li>
											<p>I am impressed with the way of cleaning. I am amazed.</p>
											<h6>Mohit Bhishikar</h6>
											<span>Director, Praxello Solutions Pvt. Ltd.</span>
										</li>
									</ul>
					...
					<div class="template-section template-section-padding-reset template-clear-fix template-background-color-1">
						...
						<!-- Call to action -->
						<div class="template-component-call-to-action" style="background-image: url(media/image/background-image/bg2.jpg);">
							<div class="template-main">
							<!-- <h3>No 1. Car Care Service Wash Booking System</h3> -->
								<h3>No 1. Car Care Service</h3>
								<a href="booking.php" class="template-component-button">Book Appointment</a>
							</div>
						</div>
						...
						<div class="template-component-feature-list template-component-feature-list-position-left template-clear-fix">
							...
							<ul class="template-layout-33x33x33 template-layout-margin-reset template-clear-fix">
								...
								<li class="template-layout-column-left">
									...
									<h5>Contact us on</h5>
              <p>
                Tel: No: <a href="tel:8956595291">+91 8956595291</a><br/>
				Mail id: <a href="mailto:helpdesk@theecca.com">helpdesk@theecca.com</a>
              </p>
								</li>
								...
								<li class="template-layout-column-center">
									...
									<h5>Our Address</h5>
									<p>
										Office No.809, 8th floor, The Global Business Hub, Beside World Trade Center, Kharadi, Pune, Maharashtra.
									</p>
								</li>
