		...
		<html>
			...
			<head>
				...
				<!--------for gallery---->
				<link rel="stylesheet" type="text/css" href="video_gallery/svvg-styles.css">
			    <link href="video_gallery/jquerysctipttop.css" rel="stylesheet" type="text/css">
				<script src="video_gallery/jquery.min.js"></script>
					...
					<div class="template-section template-section-padding-1 template-main template-align-center">
						...
						<!-- Gallery -->
						 <div class="container py-3">
						 	...
						 	<ul id="svList">
							  <li class="svThumb ytVideo" data-videoID="F8ewNy5RK_I">Feedback of our esteemed Gera North customers.</li>
								<li class="svThumb ytVideo" data-videoID="vCFTXhzm010">Feedback of our esteemed Gera North customers.</li>
								<li class="svThumb ytVideo" data-videoID="7Pno-2FjXpM">Feedback of our esteemed Gera North customers.</li>
								<li class="svThumb ytVideo" data-videoID="iE9e0faLEac">Feedback of our esteemed Gera North customers.</li>
								<li class="svThumb ytVideo" data-videoID="vAelzHVp0cA">Feedback of our esteemed Gera North customers.</li>
							</ul>
...
<!--------for gallery---->
<script src="video_gallery/speedvault.js"></script>
<!--------end gallery---->